...
out_path = '/export/home/cmorris5/Documents/testresults2.csv' #designate your own output path
...
infile = open('/export/home/cmorris5/Downloads/metastatsnew2.csv', mode = 'rb')  #designate the location of the CSV file to read
